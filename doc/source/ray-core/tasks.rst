...
.. tab-set::
    ...
    .. tab-item:: Java
        ...
        .. code-block:: java
          ...
          // a task that executes on a worker process.
...
Note the following behaviors:
  ...
  -  As the second task depends on the output of the first task, Ray won't execute the second task until the first task has finished.
