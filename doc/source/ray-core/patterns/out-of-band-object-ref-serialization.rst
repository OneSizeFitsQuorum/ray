...
until the corresponding owner worker dies. It's prone to Ray object leaks, which can lead to spilling to disk. See :ref:`this page <serialize-object-ref>` for more details.
