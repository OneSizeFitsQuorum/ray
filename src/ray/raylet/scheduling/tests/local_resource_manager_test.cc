...
TEST_F(LocalResourceManagerTest, NodeWorkersBusyDominatesIdleTime) {
  ...
  // The most recent idle event is NODE_WORKERS becoming idle (fake_time_),
...
TEST_F(LocalResourceManagerTest, PullingIdleAfterNodeWorkersDoesNotResetIdleTime) {
  ...
  // to reset to fake_time_, which was later than when NODE_WORKERS became idle,
  ...
  auto node_workers_idle_time = fake_time_;
